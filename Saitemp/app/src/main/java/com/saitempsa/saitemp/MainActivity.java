...
import com.saitempsa.saitemp.bd.saitemp.ReconstruirTabla;
...
import com.saitempsa.saitemp.consultasApi.ConsultaTablasApi;
        ...
        ConsultaTablasApi.consultaTablasApi2(getBaseContext(), url, new ApiCallbackTablas2.ApiCallback<JSONObject>() {
            ...
            public void onSuccess(JSONObject result) {
                ...
                try {
                    ...
                    JSONArray usr_app_cliente_debida_diligencia = result.getJSONArray("usr_app_clientes");
                    ...
                    ConsultaDebidaDiligencia.llenarTabla(getBaseContext(), usr_app_cliente_debida_diligencia);
